...
<head>
	...
	<title>Sistema de Gerenciamento Escolar | Login</title>
...
<div class="main_login_box">
	...
	<div class="login_control_box">
		<div class="form-group">
			<input type="email" name="email" id="email" required="required" placeholder="Digite seu E-mail" class="form-control input_control">
		</div>
		<div class="form-group">
			<input type="password" name="password" id="password" required="required" placeholder="Digite sua senha" class="form-control input_control">
		</div>
		<div class="form-group">
