<div class="content-wrapper">
		...
		<div class="box">
				<h3>Calendário<a href="javascript:;" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal">Adicionar Calendário</a></h3>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Adicionar Calendário</h4>
      </div>
